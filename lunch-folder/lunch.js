...
function whatToDoForLunch(hungry, availableTime) {
  if (hungry === false) {
    ...
    console.log("Grab a snack, you don't have much time");
  } else if (availableTime >= 20 && availableTime <= 30) {
    console.log("Cook a quick meal, you have the time");
  } else {
    console.log("GET BACK TO WORK LAZY BONES - LONG LUNCH BREAKS ARE FOR THE WEAK");
  }
}
